...
void Drawv2_STAR_BES(){
    ...
    Float_t AxisYmin = -0.029;
    Float_t AxisYmax = 0.319;
    ...
    canvas->SetTextInfo(Form("#font[42]{#scale[1.0]{ v_{2} }}"),"Y", 1,0.7,0.55,0.5,90.0);
    ...
    result->SaveAs(Form("./Picture_v2_BES.png"));
    result->SaveAs(Form("./Picture_v2_BES.pdf"));
