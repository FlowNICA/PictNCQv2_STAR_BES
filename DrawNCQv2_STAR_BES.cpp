...
void DrawNCQv2_STAR_BES(){
    ...
    canvas->SetTextInfo(Form("#font[42]{#scale[1.0]{ v_{2}/n_{q} }}"),"Y", 1,0.7,0.55,0.5,90.0);
    ...
    result->SaveAs(Form("./Picture_NCQv2_BES.png"));
    result->SaveAs(Form("./Picture_NCQv2_BES.pdf"));
